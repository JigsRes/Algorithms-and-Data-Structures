...
array = [ "put", "put", "put", "put", "put", "get", "put", "get", "get", "put", "get", "put", "put", "put",
          ...
          "put", "put", "put", "put", "put"]
values=[ [10, 13], [3, 17], [6, 11], [10, 5], [9, 10], [13], [2, 19], [2], [3], [5, 25], [8], [9, 22], [5, 5], [1, 30],
 [11], [9, 12], [7], [5], [8], [9], [4, 30], [9, 3], [9], [10], [10], [6, 14], [3, 1], [3], [10, 11], [8], [2, 14], [1],
 [5], [4], [11, 4], [12, 24], [5, 18], [13], [7, 23], [8], [12], [3, 27], [2, 12], [5], [2, 9], [13, 4], [8, 18],
...
zipped= zip(array, values)

for command, value in zipped:
    if command=="put":
        print("System.out.println(" + "\"put " + str(value[0]) + "," + str(value[1]) + "\");")
        print("obj.put("+str(value[0])+","+str(value[1])+");")
        #print("System.out.println(obj.map.keySet().size());")
    else:
        print("System.out.println("+"\"get "+ str(value[0]) + "\");")
        print("System.out.println(obj.get("+str(value[0])+"));")
    print("System.out.print(\"size\");")
    print("System.out.println(obj.map.keySet().size());")
    print

    # print("DoublyLinkedNode head = obj.head;")
    # print("while (head != null){")
    # print("System.out.print(head.key);")
